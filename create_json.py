...
def load_name_dict():
    df = pd.read_csv('data/addition/name_dictionary.csv', header=None)[1:]
...
for sample_num in range(1, 9):
    ...
    lifecycle_path = f'data/addition/WT_Sample{sample_num}/WT_Sample{sample_num}_lifescycle.csv'
    cell_lifecycles = {}
    ...
    surface_path = f'data/addition/WT_Sample{sample_num}/WT_Sample{sample_num}_surface.csv'
    volume_path = f'data/addition/WT_Sample{sample_num}/WT_Sample{sample_num}_volume.csv'
    surface_df = pd.read_csv(surface_path, index_col=0)
    volume_df = pd.read_csv(volume_path, index_col=0)

    # 3. Load contact area (Stat)
    stat_path = f'data/addition/WT_Sample{sample_num}/WT_Sample{sample_num}_Stat.csv'
